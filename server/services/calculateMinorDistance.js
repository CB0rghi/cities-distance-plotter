...
(async() => {
	...
	const state = 'SP'
	const source = 'Adamantina'
	const destiny = 'Araraquara'
	console.log(`Calculating minor distance between ${source} => ${destiny}\n`)
	console.time('Caculated Minor Distance')

	await calculateMinorDistance(state, source, destiny)
	console.timeEnd('Caculated Minor Distance')
})()
