import PriorityQueue from "../shared/data-structures/priority-queue/PriorityQueue.js"
  ...
  while (!queue.isEmpty()) {
    ...
    currentVertex.getNeighbors().forEach((neighbor) => {
      ...
      if (!visitedVertices[neighbor.getKey()]) {
        ...
        const existingDistanceToNeighbor = Number(distances[neighbor.getKey()]);
        const distanceToNeighborFromCurrent = Number(distances[currentVertex.getKey()]) + Number(edge.weight);
